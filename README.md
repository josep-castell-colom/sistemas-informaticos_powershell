...
Para ello se declara una variable llamada número usando el símbolo del dolar (`$`) y a continuación el nombre con el que se desea nombrar seguido de un igual (`=`) y el valor deseado.
